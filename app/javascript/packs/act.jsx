...
const ActSection = styled.section`
	@media only screen and (max-width: 985px) {
		...
		grid-template-columns: minmax(8px, 1fr) minmax(197px, 800px) minmax(8px, 1fr);
		min-width: 100%;
		grid-column-gap: 0;
		//justify-self: center;
	}
...
const Pic1 = styled.img`
	...
	border: ${(props) => (props.whichEmailIsActive == 1 ? "7px orange solid" : "7px white solid")};
	border: ${(props) => (props.whichEmailIsActive == 1 ? "7px orange solid" : "7px white solid")};
	width: 100px;
	height: 100px;
...
const Pic2 = styled.img`
	...
	//border: 2px solid white;
	border: ${(props) => (props.whichEmailIsActive == 2 ? "7px orange solid" : "7px white solid")};
	border: ${(props) => (props.whichEmailIsActive == 2 ? "7px orange solid" : "7px white solid")};
								...
								<LetterOfferWrapper>
									<LetterOffer>
										...
										<Row2
											...
											whichEmailIsActive={whichEmailIsActive}
										>
											<Pic2 src={results.two.image ? results.two.image : ""}></Pic2>
