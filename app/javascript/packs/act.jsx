...
const ActSection = styled.section`
  @media only screen and (max-width: 985px) {
    ...
    grid-template-columns: minmax(8px, 1fr) minmax(197px, 600px) minmax(
        8px,
        1fr
      );
    min-width: 100%;
...
const DemoIndicatorDots = styled.div`
  display: grid;
  grid-template-columns: 150px 20px 20px max-content min-content;
          ...
          >
            <Letter resultFromFlorida={resultFromFlorida} showCards={showCards}>
              ...
              <EmailDemoWrapper whichTabIsActive={whichTabIsActive}>
                ...
                <OfferOne>
                  <BulletPointText>
                    Personalized email will be sent to each of your
                    representatives.
                  </BulletPointText>
                ...
                <LetterOfferWrapper>
                  <LetterOffer>
                    ...
                    <CheckmarkMainWrapper>
                      ...
                      <CheckMarkParagraph>
                        Sending a letter via USPS is most effective way to get
                        your point across.
                      </CheckMarkParagraph>
                    </CheckmarkMainWrapper>
                    {/* <ShowOfferSectionWrapper> */}
