...
const StatusSpinner = styled.div`
	max-height: ${(props) => (props.show_status_spinner == "true" ? "100%" : "0px")};
...
const TriplePlayWrapper = styled.div`
	display: ${(props) =>
		props.show_cards == "true" && props.result_from_florida == "true" ? "grid" : "none"};
...
const Pic1 = styled.img`
	...
	border: ${(props) => (props.which_email_is_active == 1 ? "7px orange solid" : "7px white solid")};
	width: 100px;
	height: 120px;
`
...
const HowItWorksWrapper = styled.div`
	...
	display: ${(props) =>
		props.show_cards == "true" && props.result_from_florida == "false" ? "none" : "grid"};
	//display: grid;
	//max-width: 578px;
	@media only screen and (max-width: 786px) {
		justify-self: center;
...
const Pic2 = styled.img`
	...
	border: ${(props) => (props.which_email_is_active == 2 ? "7px orange solid" : "7px white solid")};
...
const Dot1 = styled.div`
	...
	border-radius: 50%;
	grid-area: dot1;
	background-color: ${(props) => (props.which_email_is_active == 1 ? "black" : "white")};
	//background-color: white;
...
const Dot2 = styled.div`
	...
	border-radius: 50%;
	grid-area: dot2;
	background-color: ${(props) => (props.which_email_is_active == 2 ? "black" : "white")};
	//background-color: white;
	border: 1px solid black;
	box-sizing: border-box;
	transition: transform 0.5s ease;
			...
			<ActWrapper show_cards={showCards} ref={LookupScrollToRef}>
				<ActGrid show_cards={showCards}>
					...
					<ResultSection show_cards={showCards}>
						<MiddleBarResultSection>
							...
							<BottomBar>
								...
								<NextSteps>
									...
									<HowItWorksWrapper result_from_florida={resultFromFlorida} show_cards={showCards}>
										<p>How it works?</p>
										<HowItWorksList>
											<p>Your personalized letters will be printed on top-notch quality paper.</p>
											<p>Mailed to both Representatives via First Class USPS mail.</p>
											<p>That's it!</p>
										</HowItWorksList>
									</HowItWorksWrapper>
									<ShowLetterDeadEnd result_from_florida={resultFromFlorida} show_cards={showCards}>
										Unfortunately, emailing officials through FloridaBlaze is only available in
										Florida.
						...
						<TriplePlayWrapper result_from_florida={resultFromFlorida} show_cards={showCards}>
							<Letter result_from_florida={resultFromFlorida} show_cards={showCards}>
										...
										<EmailDemo>
											...
											<BodyBox>
												...
												<div>
													...
													<p>
														I am writing to express my strong support for the legalization and
														regulation of marijuana for recreational use in our state. It is
														disheartening to see that many other states have embraced this
														common-sense approach while our state continues to lag behind.
													</p>

													<p>
														As a Legislator, you have the power to make a difference. I implore you
														to consider the undeniable benefits of legalizing and regulating
														marijuana for adults like myself. I firmly believe that it is time for
														our state to take this important step forward.
													</p>

													<p>
														Thank you for your attention to this matter, and I hope I can count on
														your support to bring an end to marijuana prohibition in our state.
													</p>
												</div>
												<LetterClosing>
													<p>Sincerely,</p>
													...
													<p>{addressLineOne !== "" ? addressLineOne : "[Your address]"}</p>{" "}
													<p>{addressLineTwo !== "" ? addressLineTwo : "[city, state, zipcode]"}</p>{" "}
												</LetterClosing>
										...
										<LetterDemo>
											...
											<div>
												...
												<p>
													...
													consider the undeniable benefits of legalizing and regulating marijuana
