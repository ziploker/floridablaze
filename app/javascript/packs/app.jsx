...
function App({ d }) {
	...
	//const [allStoriesPlaceholder, setAllStoriesPlaceholder] = useState(d.allStoriesPlaceholder)
	...
	const initialOptions = {
		"client-id": "ARoxFsYDjhh3TqvSuq-WCN4jIEIFuyTm_HUPob8uDtr0H8c-A4ko4Tb2X1A9Sl2pwTRERBClsNWrleR6",
	}
			...
			<ThemeProvider theme={theme}>
				...
				<Router>
					...
					<Routes>
						...
						<Route
							path="/forgot"
							element={<Forgot login_clicked={loginClicked} set_login_clicked={setLoginClicked} />}
						/>
						<Route
							path="/resend"
							element={<Resend login_clicked={loginClicked} set_login_clicked={setLoginClicked} />}
						/>
						<Route
							exact
							path="/change_pw/:token"
							element={<Change login_clicked={loginClicked} set_login_clicked={setLoginClicked} />}
						/>
