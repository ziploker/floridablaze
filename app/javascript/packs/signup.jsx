...
const SignupWrapper = styled.div`
  @media only screen and (max-width: 850px) {
    ...
    grid-template-columns: minmax(20px, 120px) minmax(300px, min-content) minmax(
        20px,
        1fr
      );
  ...
  @media only screen and (max-width: 777px) {
    grid-template-columns: minmax(20px, 1fr) minmax(300px, min-content) minmax(
        20px,
        1fr
      );
  }
    ...
    axios
      ...
      .then((reithCredentisponse) => {
        ...
        if (response.data.status == "green") {
          ...
          console.log(
            "result from google signin axios call",
            response.data.error
          );
          ...
          console.log(
            "result from google signin axios call, this should never happen"
          );
        }
      })
      .catch((error) => {
    ...
    return (
      <SignupWrapper className="homeWrapper" ref={section2ScrollToRef}>
        ...
        <RightSection>
          ...
          <WeedBulletText3>
            Get alerts on the latest marijuana laws.
          </WeedBulletText3>
          <WeedBullet4 src={thebullet} />
          <WeedBulletText4>
            Become a FloridaBlazer now. (It's totally free)
          </WeedBulletText4>
        </RightSection>
