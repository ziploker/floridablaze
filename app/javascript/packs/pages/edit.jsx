	...
	return (
		<EditAccountWrapper>
			...
			<ActivityTableWrapper>
				...
				<ActivityTable id={"activity"} allCommunications={allCommunications}>
					<tbody>
						<tr>
							<th></th>
							<th>date</th>
				...
				<NoActivity allCommunications={allCommunications}>
			...
			<h1>{allCommunications.length.toString()} ppp</h1>
		</EditAccountWrapper>
	);
}
