...
function Home(props) {
	...
	useEffect(() => {
		...
		console.log("NUMOFslides================ ", numSlides);
				...
				<MainDiv>
					<SlidesContainer className="slides-container">
						<SlidesInner className="slides-inner">
							<Slide className="slide">1</Slide>
							<Slide className="slide">2</Slide>
							<Slide className="slide">3</Slide>
							<Slide className="slide">4</Slide>
							<Slide className="slide">5</Slide>
							<Slide className="slide">6</Slide>
							<Slide className="slide">7</Slide>
							<Slide className="slide">8</Slide>
							<Slide className="slide">9</Slide>
							<Slide className="slide">10</Slide>
						</SlidesInner>
						<div id="proxy"></div>
					</SlidesContainer>
