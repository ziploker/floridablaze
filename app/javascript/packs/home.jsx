...
function Home(props) {
	...
	const [largeDots, setLargeDots] = useState([
		visibleDots[3],
		visibleDots[4],
		visibleDots[5],
		visibleDots[6],
	...
	const [smallDots, setSmallDots] = useState([visibleDots[1], visibleDots[9]]);
	const [invisibleDots, setInvisibleDots] = useState([
		visibleDots[0],
		visibleDots[10],
	]);
	...
	const getDotStyle = () => {
		...
		// 	style = {
		// 		...style,
		// 		transform: `translateX(${transitionX - 20}px)`,
