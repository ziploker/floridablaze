...
function handleReversePage(props, setLoadingStories) {
  ...
  axios
    .post(
      ...
      {
        data: {
          secondToLastStory_ID: props.stories[1].id,
          width: window.innerWidth,
        },
      },
      { withCredentials: true }
    ...
    <HomeWrapper>
      <News className="box">
        ...
        <LinkWrapper1
          to={
            "/blog/" +
            slugify(props.stories[0] ? props.stories[0].title : "nada")
          }
          state={{ art: props.stories[0] }}
        >
          <Div1
            className="s1"
            imageURL={
              props.stories[0] ? props.stories[0].urls[0] : defaultImage
            }
          ></Div1>
        </LinkWrapper1>
        ...
        <LinkWrapper2
          to={
            "/blog/" +
            slugify(props.stories[1] ? props.stories[1].title : "nada")
          }
          state={{ art: props.stories[1] }}
        >
          <Div2
            className="s1"
            imageURL={
              props.stories[1] ? props.stories[1].urls[0] : defaultImage
            }
          ></Div2>
        </LinkWrapper2>
        ...
        <LinkWrapper3
          to={
            "/blog/" +
            slugify(props.stories[2] ? props.stories[2].title : "nada")
          }
          state={{ art: props.stories[2] }}
        >
          <Div3
            className="s1"
            imageURL={
              props.stories[2] ? props.stories[2].urls[0] : defaultImage
            }
          ></Div3>
        </LinkWrapper3>
        ...
        <LinkWrapper4
          to={
            "/blog/" +
            slugify(props.stories[3] ? props.stories[3].title : "nada")
          }
          state={{ art: props.stories[3] }}
        >
          <Div4
            className="s1"
            imageURL={
              props.stories[3] ? props.stories[3].urls[0] : defaultImage
            }
          ></Div4>
        </LinkWrapper4>
