...
const LeftArrowButton = styled.div`
	...
	height: 33.33%;
	background: ${(props) =>
		props.isHovering ? "rgba(247, 247, 247, 0.6)" : "rgba(247, 247, 247, 0.27)"};
	border: 0;
	display: grid;
	z-index: 1;
	grid-area: one;
	...
	return (
		<HomeWrapper showOffer={props.showOffer}>
			...
			<News onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave} className="box">
				{/* <LeftFiller /> */}
				<LeftArrowButton isHovering={isHovering} onClick={() => handleForwardPage("desktop")}>
				...
				<RightArrowButton isHovering={isHovering} onClick={() => handleReversePage("desktop")}>
