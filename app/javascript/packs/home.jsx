...
function Home(props) {
  ...
  function handleReversePage() {
    ...
    //check allStories array has next two stories

    console.log("allStories length", allStories.length.toString());
    console.log("activeStories second value	", activeStories[1].toString());

    let storiesLeft = allStories.length - (activeStories[1] + 1);

    console.log("storiesLrfg", storiesLeft);

    if (storiesLeft > 1) {
      console.log("stories left 2 or more", storiesLeft);
      ...
      console.log("stories left == 1", storiesLeft);
      //get one more then loop back allStories
      setLoadingStories(true);
      axios
        .post(
          "/reverse/",
      ...
      console.log("stories left = 0", storiesLeft);
      ...
      axios
        ...
        .then((response) => {
          if (response.data.stories.length == 1) {
            console.log("wanted 2 but got one");
            setAllStories([...allStories, response.data.stories[0]]);
            ...
            console.log("wanted 2 but got two");
            setAllStories([
              ...allStories,
              response.data.stories[0],
              response.data.stories[1],
            ]);
